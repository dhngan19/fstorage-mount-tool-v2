...
const DropdownRight = ({isDisabled, setIsDisabled, setOpenDialogS3, setIsFromOrTo} : DropdownRightProps) => {
    ...
    },
    {
      label: (
        <Button
          ...
          onClick={() => {
            setIsDisabled(true);
            window.electron.main.getFolderSync('right');
          }}
          style={{
            width: '100%',
            height: '100%',
